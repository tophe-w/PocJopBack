...
-- Événements
INSERT INTO event (name, start_event, end_event, description, nb_people_expected, site_id, category_id) VALUES ('Fête de l''Huma', '1746112000000', '1753843200000', 'Un événement culturel et politique.', 400000, (SELECT id FROM site WHERE name = 'Base 217'), (SELECT id FROM category WHERE name = 'Culture'));
INSERT INTO event (name, start_event, end_event, description, nb_people_expected, site_id, category_id) VALUES ('Rock en Seine', '1743465600000', '1746028800000', 'Festival de musique.', 120000, (SELECT id FROM site WHERE name = 'Domaine National de Saint-Cloud'), (SELECT id FROM category WHERE name = 'Musique'));
INSERT INTO event (name, start_event, end_event, description, nb_people_expected, site_id, category_id) VALUES ('Salon de l''Agriculture', '1734940800000', '1735699200000', 'Salon sur l''agriculture.', 630000, (SELECT id FROM site WHERE name = 'Parc des Expositions'), (SELECT id FROM category WHERE name = 'Culture'));
...
-- Événements
INSERT INTO event (name, start_event, end_event, description, nb_people_expected, site_id, category_id) VALUES ('Fête des Lumières à Lyon', '1735708800000', '1754342400000', 'Un événement lumineux et culturel.', 1500000, (SELECT id FROM site WHERE name = 'Centre-ville de Lyon'), (SELECT id FROM category WHERE name = 'Culture'));
INSERT INTO event (name, start_event, end_event, description, nb_people_expected, site_id, category_id) VALUES ('Festival Lumière', '1739260800000', '1741689600000', 'Festival de cinéma à Lyon.', 200000, (SELECT id FROM site WHERE name = 'Institut Lumière'), (SELECT id FROM category WHERE name = 'Culture'));
INSERT INTO event (name, start_event, end_event, description, nb_people_expected, site_id, category_id) VALUES ('Festival Jazz à Vienne', '1688275200000', '1689494400000', 'Festival de jazz dans le théâtre antique.', 200000, (SELECT id FROM site WHERE name = 'Théâtre antique de Vienne'), (SELECT id FROM category WHERE name = 'Musique'));
...
-- Événements
INSERT INTO event (name, start_event, end_event, description, nb_people_expected, site_id, category_id) VALUES ('Festival de Cannes', '1710336000000', '1710576000000', 'Festival international du film à Cannes.', 200000, (SELECT id FROM site WHERE name = 'Palais des Festivals'), (SELECT id FROM category WHERE name = 'Culture'));
INSERT INTO event (name, start_event, end_event, description, nb_people_expected, site_id, category_id) VALUES ('Fête du Citron', '1741056000000', '1742832000000', 'Festival du citron à Menton.', 200000, (SELECT id FROM site WHERE name = 'Jardin Biovès'), (SELECT id FROM category WHERE name = 'Culture'));
INSERT INTO event (name, start_event, end_event, description, nb_people_expected, site_id, category_id) VALUES ('Les Voiles de Saint-Tropez', '1749235200000', '1750128000000', 'Régates et événements nautiques.', 300000, (SELECT id FROM site WHERE name = 'Port de Saint-Tropez'), (SELECT id FROM category WHERE name = 'Sport'));
...
-- Événements
INSERT INTO event (name, start_event, end_event, description, nb_people_expected, site_id, category_id) VALUES ('Festival de la BD à Angoulême', '1675075200000', '1676428800000', 'Célébration de la bande dessinée.', 200000, (SELECT id FROM site WHERE name = 'Angoulême'), (SELECT id FROM category WHERE name = 'Culture'));
INSERT INTO event (name, start_event, end_event, description, nb_people_expected, site_id, category_id) VALUES ('Festival International de Musique à Cognac', '1710528000000', '1710163200000', 'Festival de musique à Cognac.', 45000, (SELECT id FROM site WHERE name = 'Cognac'), (SELECT id FROM category WHERE name = 'Musique'));
INSERT INTO event (name, start_event, end_event, description, nb_people_expected, site_id, category_id) VALUES ('Festival Garorock à Marmande', '1688236800000', '1689494400000', 'Festival de musique à Marmande.', 160000, (SELECT id FROM site WHERE name = 'Plaine de la Filhole'), (SELECT id FROM category WHERE name = 'Musique'));
...
-- Événements
INSERT INTO event (name, start_event, end_event, description, nb_people_expected, site_id, category_id) VALUES ('Festival de Carcassonne', '1714982400000', '1716268800000', 'Festival de spectacles et concerts.', 250000, (SELECT id FROM site WHERE name = 'Cité Médiévale de Carcassonne'), (SELECT id FROM category WHERE name = 'Festival'));
INSERT INTO event (name, start_event, end_event, description, nb_people_expected, site_id, category_id) VALUES ('Festival International de Photojournalisme à Perpignan', '1751904000000', '1753948800000', 'Festival de photojournalisme.', 200000, (SELECT id FROM site WHERE name = 'Palais des Congrès'), (SELECT id FROM category WHERE name = 'Culture'));
INSERT INTO event (name, start_event, end_event, description, nb_people_expected, site_id, category_id) VALUES ('Les Déferlantes', '1713600000000', '1714800000000', 'Festival de musique à Argelès-sur-Mer.', 100000, (SELECT id FROM site WHERE name = 'Parc de Valmy'), (SELECT id FROM category WHERE name = 'Musique'));
...
-- Événements
INSERT INTO event (name, start_event, end_event, description, nb_people_expected, site_id, category_id) VALUES ('Marché de Noël de Strasbourg', '1750665600000', '1751030400000', 'Marché de Noël traditionnel.', 2000000, (SELECT id FROM site WHERE name = 'Marché de Noël'), (SELECT id FROM category WHERE name = 'Culture'));
INSERT INTO event (name, start_event, end_event, description, nb_people_expected, site_id, category_id) VALUES ('Fête de la Saint-Nicolas à Nancy', '1752624000000', '1752710400000', 'Célébration de la Saint-Nicolas.', 100000, (SELECT id FROM site WHERE name = 'Palais du Gouvernement'), (SELECT id FROM category WHERE name = 'Culture'));
INSERT INTO event (name, start_event, end_event, description, nb_people_expected, site_id, category_id) VALUES ('Festival International de Colmar', '1688236800000', '1688745600000', 'Festival de musique classique.', 10000, (SELECT id FROM site WHERE name = 'Parc des Expositions de Colmar'), (SELECT id FROM category WHERE name = 'Musique'));
...
-- Événements
INSERT INTO event (name, start_event, end_event, description, nb_people_expected, site_id, category_id) VALUES ('Braderie de Lille', '1752067200000', '1752393600000', 'Grande foire commerciale.', 3000000, (SELECT id FROM site WHERE name = 'Gare de Lille-Flandres'), (SELECT id FROM category WHERE name = 'Culture'));
INSERT INTO event (name, start_event, end_event, description, nb_people_expected, site_id, category_id) VALUES ('Festival de l''Accordéon à Tournai', '1752508800000', '1752729600000', 'Festival d''accordéon.', 10000, (SELECT id FROM site WHERE name = 'Grand Place de Tournai'), (SELECT id FROM category WHERE name = 'Musique'));
INSERT INTO event (name, start_event, end_event, description, nb_people_expected, site_id, category_id) VALUES ('Main Square Festival à Arras', '1710336000000', '1710576000000', 'Festival de musique.', 125000, (SELECT id FROM site WHERE name = 'Citadelle d''Arras'), (SELECT id FROM category WHERE name = 'Musique'));
...
-- Événements
INSERT INTO event (name, start_event, end_event, description, nb_people_expected, site_id, category_id) VALUES ('Fête de la Vigne à Dijon', '1679539200000', '1682006400000', 'Célébration des vignes.', 50000, (SELECT id FROM site WHERE name = 'Fête de la Vigne'), (SELECT id FROM category WHERE name = 'Culture'));
INSERT INTO event (name, start_event, end_event, description, nb_people_expected, site_id, category_id) VALUES ('Festival International du Film Policier à Beaune', '1680451200000', '1682803200000', 'Festival du film policier.', 10000, (SELECT id FROM site WHERE name = 'Théâtre de Beaune'), (SELECT id FROM category WHERE name = 'Culture'));
INSERT INTO event (name, start_event, end_event, description, nb_people_expected, site_id, category_id) VALUES ('Festival de Musique Baroque à Besançon', '1712179200000', '1712995200000', 'Festival de musique baroque.', 25000, (SELECT id FROM site WHERE name = 'Centre-ville de Besançon'), (SELECT id FROM category WHERE name = 'Musique'));
...
-- Événements
INSERT INTO event (name, start_event, end_event, description, nb_people_expected, site_id, category_id) VALUES ('Armada de Rouen', '1750617600000', '1751193600000', 'Événement maritime de grande envergure.', 10000000, (SELECT id FROM site WHERE name = 'Port de Rouen'), (SELECT id FROM category WHERE name = 'Culture'));
INSERT INTO event (name, start_event, end_event, description, nb_people_expected, site_id, category_id) VALUES ('Festival Beauregard à Hérouville-Saint-Clair', '1711046400000', '1711795200000', 'Festival de musique.', 110000, (SELECT id FROM site WHERE name = 'Château de Beauregard'), (SELECT id FROM category WHERE name = 'Musique'));
INSERT INTO event (name, start_event, end_event, description, nb_people_expected, site_id, category_id) VALUES ('Fête de la Mer à Dieppe', '1755225600000', '1756348800000', 'Événement maritime.', 250000, (SELECT id FROM site WHERE name = 'Plage de Dieppe'), (SELECT id FROM category WHERE name = 'Culture'));
...
-- Événements
INSERT INTO event (name, start_event, end_event, description, nb_people_expected, site_id, category_id) VALUES ('Les Fêtes Johanniques à Orléans', '1682726400000', '1683883200000', 'Célébration historique.', 100000, (SELECT id FROM site WHERE name = 'Cathédrale d''Orléans'), (SELECT id FROM category WHERE name = 'Culture'));
INSERT INTO event (name, start_event, end_event, description, nb_people_expected, site_id, category_id) VALUES ('Festival de Loire à Orléans', '1752528000000', '1752652800000', 'Festival sur la Loire.', 650000, (SELECT id FROM site WHERE name = 'Berges de la Loire'), (SELECT id FROM category WHERE name = 'Culture'));
INSERT INTO event (name, start_event, end_event, description, nb_people_expected, site_id, category_id) VALUES ('Le Printemps de Bourges', '1682304000000', '1682870400000', 'Festival de musique.', 200000, (SELECT id FROM site WHERE name = 'Parc des Expositions de Bourges'), (SELECT id FROM category WHERE name = 'Musique'));
...
-- Événements
INSERT INTO event (name, start_event, end_event, description, nb_people_expected, site_id, category_id) VALUES ('Hellfest à Clisson', '1710336000000', '1710662400000', 'Festival de musique métal.', 180000, (SELECT id FROM site WHERE name = 'Clisson'), (SELECT id FROM category WHERE name = 'Musique'));
INSERT INTO event (name, start_event, end_event, description, nb_people_expected, site_id, category_id) VALUES ('Les Folles Journées à Nantes', '1675075200000', '1675737600000', 'Festival de musique classique.', 150000, (SELECT id FROM site WHERE name = 'Cité des Congrès'), (SELECT id FROM category WHERE name = 'Culture'));
INSERT INTO event (name, start_event, end_event, description, nb_people_expected, site_id, category_id) VALUES ('La Nuit de l''Erdre à Nort-sur-Erdre', '1710873600000', '1711008000000', 'Festival de musique.', 45000, (SELECT id FROM site WHERE name = 'Parc du Port Mulon'), (SELECT id FROM category WHERE name = 'Musique'));
...
-- Événements
INSERT INTO event (name, start_event, end_event, description, nb_people_expected, site_id, category_id) VALUES ('Festival Interceltique de Lorient', '1742630400000', '1744051200000', 'Festival de culture celtique.', 800000, (SELECT id FROM site WHERE name = 'Gare de Lorient'), (SELECT id FROM category WHERE name = 'Culture'));
INSERT INTO event (name, start_event, end_event, description, nb_people_expected, site_id, category_id) VALUES ('Les Vieilles Charrues à Carhaix', '1744252800000', '1744891200000', 'Festival de musique.', 280000, (SELECT id FROM site WHERE name = 'Prairies de Kerampuilh'), (SELECT id FROM category WHERE name = 'Musique'));
INSERT INTO event (name, start_event, end_event, description, nb_people_expected, site_id, category_id) VALUES ('Festival du Bout du Monde à Crozon', '1745932800000', '1746148800000', 'Événement musical et culturel.', 60000, (SELECT id FROM site WHERE name = 'Presqu''île de Crozon'), (SELECT id FROM category WHERE name = 'Festival'));
