...
-- Gares
INSERT INTO gare (name, code, plan_de_gare, plan_de_gare_svg, accessibilite, region_id) VALUES ('Gare de Nantes', 'GARE_DE_NANTES', 'assets/gares/plan_de_gare_NANTES.jpg', 'assets/gares/plan_de_gare_NANTES.svg', 'Accessible', (SELECT id FROM region WHERE name = 'Pays de la Loire'));
INSERT INTO gare (name, code, plan_de_gare, plan_de_gare_svg, accessibilite, region_id) VALUES ('Gare d''Angers', 'GARE_DE_ANGERS', 'assets/gares/plan_de_gare_ANGERS.jpg', 'assets/gares/plan_de_gare_ANGERS.svg', 'Accessible', (SELECT id FROM region WHERE name = 'Pays de la Loire'));
INSERT INTO gare (name, code, plan_de_gare, plan_de_gare_svg, accessibilite, region_id) VALUES ('Gare de Saint-Nazaire', 'GARE_DE_SAINT_NAZAIRE', 'assets/gares/plan_de_gare_SAINT_NAZAIRE.jpg', 'assets/gares/plan_de_gare_SAINT_NAZAIRE.svg', 'Accessible', (SELECT id FROM region WHERE name = 'Pays de la Loire'));
INSERT INTO gare (name, code, plan_de_gare, plan_de_gare_svg, accessibilite, region_id) VALUES ('Gare de La Roche-sur-Yon', 'GARE_DE_LA_ROCHE_SUR_YON', 'assets/gares/plan_de_gare_LA_ROCHE_SUR_YON.jpg', 'assets/gares/plan_de_gare_LA_ROCHE_SUR_YON.svg', 'Accessible', (SELECT id FROM region WHERE name = 'Pays de la Loire'));
INSERT INTO gare (name, code, plan_de_gare, plan_de_gare_svg, accessibilite, region_id) VALUES ('Gare de Cholet', 'GARE_DE_CHOLET', 'assets/gares/plan_de_gare_CHOLET.jpg', 'assets/gares/plan_de_gare_CHOLET.svg', 'Accessible', (SELECT id FROM region WHERE name = 'Pays de la Loire'));
INSERT INTO gare (name, code, plan_de_gare, plan_de_gare_svg, accessibilite, region_id) VALUES ('Gare de Les Sables-d''Olonne', 'GARE_DE_SABLES', 'assets/gares/plan_de_gare_SABLES.jpg', 'assets/gares/plan_de_gare_SABLES.svg', 'Accessible', (SELECT id FROM region WHERE name = 'Pays de la Loire'));
INSERT INTO gare (name, code, plan_de_gare, plan_de_gare_svg, accessibilite, region_id) VALUES ('Gare de La Baule', 'GARE_DE_LA_BAULE', 'assets/gares/plan_de_gare_LA_BAULE.jpg', 'assets/gares/plan_de_gare_LA_BAULE.svg', 'Accessible', (SELECT id FROM region WHERE name = 'Pays de la Loire'));
INSERT INTO gare (name, code, plan_de_gare, plan_de_gare_svg, accessibilite, region_id) VALUES ('Gare d''Ancenis', 'GARE_DE_ANCENIS', 'assets/gares/plan_de_gare_ANCENIS.jpg', 'assets/gares/plan_de_gare_ANCENIS.svg', 'Accessible', (SELECT id FROM region WHERE name = 'Pays de la Loire'));
INSERT INTO gare (name, code, plan_de_gare, plan_de_gare_svg, accessibilite, region_id) VALUES ('Gare de Laval', 'GARE_DE_LAVAL', 'assets/gares/plan_de_gare_LAVAL.jpg', 'assets/gares/plan_de_gare_LAVAL.svg', 'Accessible', (SELECT id FROM region WHERE name = 'Pays de la Loire'));
...
-- Insertion des gares
INSERT INTO gare (name, code, plan_de_gare, plan_de_gare_svg, accessibilite, region_id) VALUES ('Gare de Rennes', 'GARE_DE_RENNES', 'assets/gares/plan_de_gare_RENNES.jpg', 'assets/gares/plan_de_gare_RENNES.svg', 'Accessible', (SELECT id FROM region WHERE name = 'Bretagne'));
INSERT INTO gare (name, code, plan_de_gare, plan_de_gare_svg, accessibilite, region_id) VALUES ('Gare de Brest', 'GARE_DE_BREST', 'assets/gares/plan_de_gare_BREST.jpg', 'assets/gares/plan_de_gare_BREST.svg', 'Accessible', (SELECT id FROM region WHERE name = 'Bretagne'));
INSERT INTO gare (name, code, plan_de_gare, plan_de_gare_svg, accessibilite, region_id) VALUES ('Gare de Saint-Malo', 'GARE_DE_SAINT_MALO', 'assets/gares/plan_de_gare_SAINT_MALO.jpg', 'assets/gares/plan_de_gare_SAINT_MALO.svg', 'Accessible', (SELECT id FROM region WHERE name = 'Bretagne'));
INSERT INTO gare (name, code, plan_de_gare, plan_de_gare_svg, accessibilite, region_id) VALUES ('Gare de Lorient', 'GARE_DE_LORIENT', 'assets/gares/plan_de_gare_LORIENT.jpg', 'assets/gares/plan_de_gare_LORIENT.svg', 'Accessible', (SELECT id FROM region WHERE name = 'Bretagne'));
INSERT INTO gare (name, code, plan_de_gare, plan_de_gare_svg, accessibilite, region_id) VALUES ('Gare de Quimper', 'GARE_DE_QUIMPER', 'assets/gares/plan_de_gare_QUIMPER.jpg', 'assets/gares/plan_de_gare_QUIMPER.svg', 'Accessible', (SELECT id FROM region WHERE name = 'Bretagne'));
...
INSERT INTO gare (name, code, plan_de_gare, plan_de_gare_svg, accessibilite, region_id) VALUES ('Gare de Montpellier', 'GARE_DE_MONTPELLIER', 'assets/gares/plan_de_gare_MONTPELLIER.jpg', 'assets/gares/plan_de_gare_MONTPELLIER.svg', 'Accessible', (SELECT id FROM region WHERE name = 'Occitanie'));
INSERT INTO gare (name, code, plan_de_gare, plan_de_gare_svg, accessibilite, region_id) VALUES ('Gare de Nîmes', 'GARE_DE_NIMES', 'assets/gares/plan_de_gare_NIMES.jpg', 'assets/gares/plan_de_gare_NIMES.svg', 'Accessible', (SELECT id FROM region WHERE name = 'Occitanie'));
INSERT INTO gare (name, code, plan_de_gare, plan_de_gare_svg, accessibilite, region_id) VALUES ('Gare de Perpignan', 'GARE_DE_PERPIGNAN', 'assets/gares/plan_de_gare_PERPIGNAN.jpg', 'assets/gares/plan_de_gare_PERPIGNAN.svg', 'Accessible', (SELECT id FROM region WHERE name = 'Occitanie'));
INSERT INTO gare (name, code, plan_de_gare, plan_de_gare_svg, accessibilite, region_id) VALUES ('Gare de Carcassonne', 'GARE_DE_CARCASSONNE', 'assets/gares/plan_de_gare_CARCASSONNE.jpg', 'assets/gares/plan_de_gare_CARCASSONNE.svg', 'Accessible', (SELECT id FROM region WHERE name = 'Occitanie'));
INSERT INTO gare (name, code, plan_de_gare, plan_de_gare_svg, accessibilite, region_id) VALUES ('Gare de Narbonne', 'GARE_DE_NARBONNE', 'assets/gares/plan_de_gare_NARBONNE.jpg', 'assets/gares/plan_de_gare_NARBONNE.svg', 'Accessible', (SELECT id FROM region WHERE name = 'Occitanie'));
INSERT INTO gare (name, code, plan_de_gare, plan_de_gare_svg, accessibilite, region_id) VALUES ('Gare d''Albi', 'GARE_D_ALBI', 'assets/gares/plan_de_gare_ALBI.jpg', 'assets/gares/plan_de_gare_ALBI.svg', 'Accessible', (SELECT id FROM region WHERE name = 'Occitanie'));
INSERT INTO gare (name, code, plan_de_gare, plan_de_gare_svg, accessibilite, region_id) VALUES ('Gare de Béziers', 'GARE_DE_BEZIERS', 'assets/gares/plan_de_gare_BEZIERS.jpg', 'assets/gares/plan_de_gare_BEZIERS.svg', 'Accessible', (SELECT id FROM region WHERE name = 'Occitanie'));
INSERT INTO gare (name, code, plan_de_gare, plan_de_gare_svg, accessibilite, region_id) VALUES ('Gare de Mende', 'GARE_DE_MENDE', 'assets/gares/plan_de_gare_MENDE.jpg', 'assets/gares/plan_de_gare_MENDE.svg', 'Accessible', (SELECT id FROM region WHERE name = 'Occitanie'));
